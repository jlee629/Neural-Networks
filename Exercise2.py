# -*- coding: utf-8 -*-
"""
Created on Sun Nov 20 23:07:01 2022
...
input_Jungyu = np.random.uniform(-0.6, 0.6, (10,2))

#3. Create output data
output_Jungyu = input_Jungyu.sum(axis=1).reshape(10, 1)
...
# 2-3 Set the training algorithm to Gradient descent backpropogation
